...
<body>
   ...
   <form id="insertStudent"  action="${pageContext.request.contextPath }/student/insertSubmit.action" method="post" enctype="multipart/form-data">
      ...
      <input type="Date" class="form-control" id="studentDOB"name="DOB" value='${student.DOB }' pattern='yyyy-MM-dd'>
      </div>
      <div class="form-group">
      <label for="studentmajor">专业</label>
      <input type="text" class="form-control" id="studentmajor"name="major">
      </div>
      <div class="form-group">
